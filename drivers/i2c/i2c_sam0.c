...
#ifdef CONFIG_I2C_0
static struct device DEVICE_NAME_GET(i2c0_sam0);

static void i2c0_sam0_irq_config(void)
{
	IRQ_CONNECT(CONFIG_I2C_0_IRQ, CONFIG_I2C_0_IRQ_PRI, i2c_sam0_isr,
		    DEVICE_GET(i2c0_sam), 0);
}

static const struct soc_gpio_pin pins_twi0[] = PINS_TWI0;

static const struct i2c_sam0_dev_cfg i2c0_sam0_config = {
	.regs = (Twi *)CONFIG_I2C_0_BASE_ADDRESS,
	.irq_config = i2c0_sam0_irq_config,
...
static struct i2c_sam0_dev_data i2c0_sam0_data;

DEVICE_AND_API_INIT(i2c0_sam, CONFIG_I2C_0_NAME, &i2c_sam0_initialize,
		    &i2c0_sam0_data, &i2c0_sam0_config, POST_KERNEL,
...
#ifdef CONFIG_I2C_1
static struct device DEVICE_NAME_GET(i2c1_sam0);

static void i2c1_sam0_irq_config(void)
{
	IRQ_CONNECT(CONFIG_I2C_1_IRQ, CONFIG_I2C_1_IRQ_PRI, i2c_sam0_isr,
		    DEVICE_GET(i2c1_sam0), 0);
}

static const struct soc_gpio_pin pins_twi1[] = PINS_TWI1;

static const struct i2c_sam0_dev_cfg i2c1_sam0_config = {
...
static struct i2c_sam0_dev_data i2c1_sam0_data;

DEVICE_AND_API_INIT(i2c1_sam0, CONFIG_I2C_1_NAME, &i2c_sam0_initialize,
		    &i2c1_sam0_data, &i2c1_sam0_config, POST_KERNEL,
		    CONFIG_I2C_INIT_PRIORITY, &i2c_sam0_driver_api);
#endif
